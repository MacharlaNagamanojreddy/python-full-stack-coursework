...
| **Day 10** | [nestedloop.py](day 10/nestedloop.py) | Nested loops & patterns: stars, numbers, squares, triangles, reverses |
...
2. **Run examples** (use `python3` on macOS):
   ...
   python3 'day 10/nestedloop.py'  # Nested loop patterns
   python3 'day 11/passbyvalue.py'  # Pass by value/reference
